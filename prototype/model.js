...
export const directions = [
  { id: 'fieldnotes', name: 'Fieldnotes', description: 'Forest · practice journal' },
  { id: 'blueprint', name: 'Blueprint', description: 'Ink · compact workbench' },
  { id: 'ember', name: 'Ember', description: 'Charcoal · journey first' },
];
...
export const scenes = [
  ...
  ['Blueprint direction', 'welcome?direction=blueprint', 'Ink-blue compact workbench'],
  ['Ember direction', 'welcome?direction=ember', 'Warm journey-first layout'],
